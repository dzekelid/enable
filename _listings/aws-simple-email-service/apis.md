...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/apis.md
...
- name: AWS Simple Email Service API - Set Identity Dkim Enabled
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentitydkimenabled-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentitydkimenabled-get-openapi.md
- name: AWS Simple Email Service API - Set Identity Feedback Forwarding Enabled
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentityfeedbackforwardingenabled-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentityfeedbackforwardingenabled-get-openapi.md
- name: AWS Simple Email Service API - Set Identity Headers In Notifications Enabled
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentityheadersinnotificationsenabled-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentityheadersinnotificationsenabled-get-openapi.md
- name: AWS Simple Email Service API - Set Identity Mail From Domain
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentitymailfromdomain-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-simple-email-service/actionsetidentitymailfromdomain-get-openapi.md
- name: AWS Simple Email Service API - Set Identity Dkim Enabled
  x-api-slug: actionsetidentitydkimenabled-get
  description: |-
    Enables or disables Easy DKIM signing of email sent from an identity:If Easy DKIM
