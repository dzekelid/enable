...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-directory-service/apis.md
...
- name: AWS Directory Service API - Enable Radius
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-directory-service/actionenableradius-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-directory-service/actionenableradius-get-openapi.md
- name: AWS Directory Service API - Enable Sso
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-directory-service/actionenablesso-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-directory-service/actionenablesso-get-openapi.md
x-common:
- type: x-api-gallery
