...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-key-management-service/apis.md
...
- name: AWS Key Management Service API - Enable Key
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-key-management-service/actionenablekey-get-openapi.md
- name: AWS Key Management Service API - Enable Key Rotation
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enable/master/_listings/aws-key-management-service/actionenablekeyrotation-get-openapi.md
x-common:
- type: x-api-gallery
